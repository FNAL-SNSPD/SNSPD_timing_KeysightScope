...
if (__name__=="__main__"):
    ...
    filename_ch1="~/Downloads/Wavenewscope_CH1_B4_P1_BV0p2.h5" 
    filename_ch3="~/Downloads/Wavenewscope_CH2_B4_P1_BV0p2.h5"
    ...
    for i in range(wv_length):
        ...
        if sp_time*find_rising_time_ch3(filename_ch3,i+1)<6.6:
